...
/**
 * <p>
 * This class will check if the LHS value is one of the RHS values.
 * <p>
 *  
 * @author Amjath Khan
 * @version 1.0
...
{
	/**
	 * The method will evaluate is the LHS is one of the RHS values
	 * 
	 * @param leftHandValue The left hand value
	 * @param rightHandValues List of right hand values
	 * @return true if LHS is in RHS list, else false
	 * 
	 * @author Amjath Khan
	 * @version 1.0 
	 * @since 1.0
