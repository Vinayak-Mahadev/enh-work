...
update interface.ms_interface set name_v = 'INTFS001A - Sales Allocation (Starter Pack - Stock Dump) & INTTNM002 - Starterpack Stock Dump' where interface_id_n in (1001,1002);
...
update interface.ms_interface set name_v = 'INTFS001B - Sales Allocation (Starter Pack - Alloc Dump) & INTTNM003 - Starterpack Allocation Dump' where interface_id_n in (1003,1004);
...
update interface.ms_interface set name_v = 'INTFS002A - Sales Allocation (Vouchers - Stock Dump) & INTTNM004 - Voucher Stock Dump' where interface_id_n in (1005,1006);
...
update interface.ms_interface set name_v = 'INTFS002B - Sales Allocation (Vouchers - Alloc Dump) & INTTNM005 - Voucher Allocation Dump' where interface_id_n in (1007,1008);
...
update interface.ms_interface set name_v = 'INTFS003 - Product Creation & INTTNM001 - Product Dump' where interface_id_n in (1009,1010);
...
update interface.ms_interface set name_v = 'INTFS004 - Serail Number Expiry & INTTNM006 - Extend Expiry Date' where interface_id_n in (1011,1012);
...
update interface.ms_interface_attr set value_v = 'SERIAL_NUMBER_SIM;M;R;[0-9]+|NEW_PRODUCT_CODE;M|NEW_EXPIRY_DATE;M;D;yyyy-MM-dd' where attribute_id_n = 1011036;
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
