package com.enhancesys.integration.snoc.util.condition;
import java.util.Map;
import java.util.Stack;

import com.enhancesys.integration.snoc.util.condition.expression.AbstractExpression;
import com.enhancesys.integration.snoc.util.condition.expression.AbstractExpression.EvaluationFailedException;
import com.enhancesys.integration.snoc.util.condition.expression.DataExpression;
import com.enhancesys.integration.snoc.util.condition.expression.DataExpression.MalformedExpressionException;
import com.enhancesys.integration.snoc.util.condition.expression.LogicalAndExpression;
import com.enhancesys.integration.snoc.util.condition.expression.LogicalExpression;
import com.enhancesys.integration.snoc.util.condition.expression.LogicalOrExpression;
