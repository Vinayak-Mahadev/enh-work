...
final class PropertiesLoader 
{
	...
	private static void loadProperties()
	{
		...
		try 
		{
			...
			file = new File(DataConstants._JOB_CONFIG_COMMON_FILE);

			LOGGER.info("Configuration Path : " + DataConstants._JOB_CONFIG_COMMON_FILE);
	...
	static String getValueFor(String key)
	{
		try
		{
			if(properties == null)
