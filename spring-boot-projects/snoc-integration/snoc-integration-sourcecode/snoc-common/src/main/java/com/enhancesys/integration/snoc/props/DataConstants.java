...
public interface DataConstants
{
	...
	{
		static final  String PROJECT_LOC = "E:/interface/work/enh-work/spring-boot-projects/snoc-integration/snoc_integration_conf";
	...
	public static final String _CONF_PATH = _PROJECT_LOC;
	public static final String _SPRING_BEANS_PATH = _PROJECT_LOC + "/beans/spring-config.xml";
	public static final String _TEMPLATE_CONFIG_PATH = _PROJECT_LOC + "/JobTemplateConfig.json";
	public static final String _COMMON_CONFIG_PATH = _PROJECT_LOC + "/common/";
	public static final String _CONFIG_COMMON_FILE = _COMMON_CONFIG_PATH + "jobConfiguration.properties";
	...
	public static final String _SORT_SCRIPTS_PATH = _PROJECT_LOC + "/sorting-scripts/";
	public static final String _SORT_SCRIPTS_CONF_FILE_PATH = _PROJECT_LOC + "/sorting-scripts/files/";

	public static final String _PROCESS_FILE_PATH                    = _PROJECT_LOC + "/job_data/";
	public static final String _PROCESS_RUN_SCRIPT                   = _PROJECT_LOC + "/run-scripts/JobServicesWebInitiator.sh";
	public static final String _PROCESS_KILL_SCRIPT                  = _PROJECT_LOC + "/run-scripts/KILL_JobServices.sh";
