...
public class IntegrationManagementImpl implements IntegrationManagementLocal 
{
	...
	protected static Logger LOGGER = Logger.getLogger(IntegrationManagementImpl.class);
	...
	public Module getModuleByName(final String name) throws ApplicationException 
	{
		try 
		{
			return snocServices.getModuleByName(name);
		} 
		catch (Exception e) 
		{
	...
	@Override
	public Module getModule(final Long moduleId) throws ApplicationException 
	{
		try 
		{
