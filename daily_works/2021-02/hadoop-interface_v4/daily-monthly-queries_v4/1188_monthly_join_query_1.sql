--1188_MONTHLY_JOIN_QUERY_1=
select 
	1188 as interface_id_n, 
...
from 
	...
	from 
		(select 
			...
			1 as id_flag 
		from 
			kpi.tr_temp_site_quro_qsso_aggr temp 
	...
	left join kpi.tr_monthly_site_quro_qsso_aggr monthly1 on temp1.month_id_n = monthly1.month_id_n 
