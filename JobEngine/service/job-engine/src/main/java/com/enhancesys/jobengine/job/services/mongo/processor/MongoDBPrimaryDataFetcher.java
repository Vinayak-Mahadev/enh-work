...
public class MongoDBPrimaryDataFetcher extends DBProcessor
{
	...
	private static Logger log = Logger.getLogger(MongoDBPrimaryDataFetcher.class);
	...
	public void init(String pipeLineName, String processorName, JSONObject primaryConfig, JobConfigurationReader jobConfigurationReader, JSONObject jobParameters) throws Exception
	{
		...
		try
		{
			...
			cursor = mongoDataUtil.getCursor((JSONObject) collectionArr.get(collectionPosition), true);
