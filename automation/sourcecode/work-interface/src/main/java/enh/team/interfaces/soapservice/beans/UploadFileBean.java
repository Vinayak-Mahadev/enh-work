...
public class UploadFileBean implements Serializable
{
	...
	public String getXMLMarshal()throws Exception
	{
		...
		try 
		{
			jc = JAXBContext.newInstance(UploadFileBean.class);
		...
		{
			throw new  Exception("Internal :: UploadFileBean XMLMarshal issue", e);
		}
		return response;
	}
	
	private static final String INTERFACE_REQ = "<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:int=\"http://com/enhancesys/integration/services/interfaces/IntegrationManagement\"> <soapenv:Header/> <soapenv:Body> <int:uploadFiles> UPLOAD_FILE_BEAN_REQUEST </int:uploadFiles> </soapenv:Body> </soapenv:Envelope>"; 
	
	public String createRequestForInterface() throws Exception
	{
		try 
		{
			return formatXml(INTERFACE_REQ.replaceAll("UPLOAD_FILE_BEAN_REQUEST", getXMLMarshal()));
		} 
		catch (Exception e) 
		{
