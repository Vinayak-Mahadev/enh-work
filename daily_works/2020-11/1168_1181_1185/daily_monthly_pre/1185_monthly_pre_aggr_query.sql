--1185_MONTHLY_PRE_AGGR_QUERY=
update
	kpi.tr_monthly_dssf_attendance_aggr as monthly
set
...
from
	...
	where 
		day_id_n in (select distinct(id_n) from kpi.tr_temp_dssf_attendance_aggr where file_id_n = ?)
	group by 
