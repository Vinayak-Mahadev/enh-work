...
public class ReportServiceUtility
{
	...
	public static long getRequestId() throws Exception
	{
		...
		if (ReportServiceUtility.count > maxCount)
		{
			...
			{
				ReportServiceUtility.count = 6001;
			}
		}
		
		return Long.parseLong(dateFormatter.format(new Date()) + String.format("%04d", ReportServiceUtility.count));
	}
