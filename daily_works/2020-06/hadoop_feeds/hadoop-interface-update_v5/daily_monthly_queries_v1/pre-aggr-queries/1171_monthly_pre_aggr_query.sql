--1171_MONTHLY_PRE_AGGR_QUERY=
update
	kpi.tr_monthly_closing_balance_aggr as monthly
set
...
from
	...
	from 
		kpi.tr_daily_closing_balance_aggr
	where 
		day_id_n in (select distinct(id_n) from kpi.tr_temp_closing_balance_aggr where file_id_n = ?)
	group by 
