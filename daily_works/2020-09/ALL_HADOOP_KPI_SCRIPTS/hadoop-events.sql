...
insert into kpi.ms_event_type_master (event_type_n, event_type_name_v, system_type_v, system_event_v) values (317, 'Outlet Starter-Pack Tagging', 'Hadoop', '1182');
...
insert into kpi.mp_event_format_mapping (event_type_n, format_type_v, format_v, definition_v, date_key_v, date_format_v, source_key_v, source_type_n, instance_key_v, instance_type_n) values(304, 'Csv', 'DATE|CLUSTER|MICRO|SITE_ID|ID_OUTLET|STATUS_INJECTION|FLAG_ACM|COUNT_MSISDN', 'Aggregation', 'DATE', 'yyyyMMdd', 'MICRO', 13, null, null);
...
insert into kpi.mp_event_format_mapping (event_type_n, format_type_v, format_v, definition_v, date_key_v, date_format_v, source_key_v, source_type_n, instance_key_v, instance_type_n) values(307, 'Csv', 'DATE|MICRO|SITE_ID|REVENUE_TYPE|REVENUE_TOTAL', 'Aggregation', 'DATE', 'yyyyMMdd', 'MICRO', 13, null, null);

insert into kpi.mp_event_format_mapping (event_type_n, format_type_v, format_v, definition_v, date_key_v, date_format_v, source_key_v, source_type_n, instance_key_v, instance_type_n) values(308, 'Csv', 'DATE|MICRO|SITE_ID|REVENUE', 'Aggregation', 'DATE', 'yyyyMMdd', 'MICRO', 13, null, null);

insert into kpi.mp_event_format_mapping (event_type_n, format_type_v, format_v, definition_v, date_key_v, date_format_v, source_key_v, source_type_n, instance_key_v, instance_type_n) values(309, 'Csv', 'DATE|MICRO|SITE_ID|REVENUE', 'Aggregation', 'DATE', 'yyyyMMdd', 'MICRO', 13, null, null);

insert into kpi.mp_event_format_mapping (event_type_n, format_type_v, format_v, definition_v, date_key_v, date_format_v, source_key_v, source_type_n, instance_key_v, instance_type_n) values(310, 'Csv', 'DATE|MICRO|SITE_ID|CATEGORY|TARGET|REVENUE', 'Aggregation', 'DATE', 'yyyyMMdd', 'MICRO', 13, null, null);

insert into kpi.mp_event_format_mapping (event_type_n, format_type_v, format_v, definition_v, date_key_v, date_format_v, source_key_v, source_type_n, instance_key_v, instance_type_n) values(311, 'Csv', 'DATE|MICRO|SITE|QTY', 'Aggregation', 'DATE', 'yyyyMMdd', 'MICRO', 13, null, null);
...
insert into kpi.mp_event_actor_mapping (event_type_n, configuration_n, actor_key_v, description_v, actor_type_n, actor_id_n, is_default_bl) values (307, 1, 'SITE_ID', 'Site Master', 12, null, true);

insert into kpi.mp_event_actor_mapping (event_type_n, configuration_n, actor_key_v, description_v, actor_type_n, actor_id_n, is_default_bl) values (308, 1, 'SITE_ID', 'Site Master', 12, null, true);

insert into kpi.mp_event_actor_mapping (event_type_n, configuration_n, actor_key_v, description_v, actor_type_n, actor_id_n, is_default_bl) values (309, 1, 'SITE_ID', 'Site Master', 12, null, true);

insert into kpi.mp_event_actor_mapping (event_type_n, configuration_n, actor_key_v, description_v, actor_type_n, actor_id_n, is_default_bl) values (310, 1, 'SITE_ID', 'Site Master', 12, null, true);

insert into kpi.mp_event_actor_mapping (event_type_n, configuration_n, actor_key_v, description_v, actor_type_n, actor_id_n, is_default_bl) values (311, 1, 'SITE', 'Site Master', 12, null, true);
...
insert into kpi.mp_event_dimension_mapping (event_type_n, configuration_n, dimension_v, description_v, sequence_n, expression_v, procedure_v, correction_v) values (301, 1, 'AMOUNT', 'Amount', 1, null, null, 'Replace');

insert into kpi.mp_event_dimension_mapping (event_type_n, configuration_n, dimension_v, description_v, sequence_n, expression_v, procedure_v, correction_v) values (302, 1, 'AMOUNT', 'Amount', 1, null, null, 'Replace');

insert into kpi.mp_event_dimension_mapping (event_type_n, configuration_n, dimension_v, description_v, sequence_n, expression_v, procedure_v, correction_v) values (303, 1, 'QTY', 'Qty', 1, null, null, 'Replace');
insert into kpi.mp_event_dimension_mapping (event_type_n, configuration_n, dimension_v, description_v, sequence_n, expression_v, procedure_v, correction_v) values (303, 1, 'AMOUNT', 'Amount', 2, null, null, 'Replace');

insert into kpi.mp_event_dimension_mapping (event_type_n, configuration_n, dimension_v, description_v, sequence_n, expression_v, procedure_v, correction_v) values (304, 1, 'COUNT_MSISDN', 'Msisdn Count', 1, null, null, 'Replace');

insert into kpi.mp_event_dimension_mapping (event_type_n, configuration_n, dimension_v, description_v, sequence_n, expression_v, procedure_v, correction_v) values (305, 1, 'AMOUNT', 'Amount', 1, null, null, 'Replace');

insert into kpi.mp_event_dimension_mapping (event_type_n, configuration_n, dimension_v, description_v, sequence_n, expression_v, procedure_v, correction_v) values (306, 1, 'AMOUNT', 'Amount', 1, null, null, 'Replace');

insert into kpi.mp_event_dimension_mapping (event_type_n, configuration_n, dimension_v, description_v, sequence_n, expression_v, procedure_v, correction_v) values (307, 1, 'REVENUE_TOTAL', 'Revenue Total', 1, null, null, 'Replace');

insert into kpi.mp_event_dimension_mapping (event_type_n, configuration_n, dimension_v, description_v, sequence_n, expression_v, procedure_v, correction_v) values (308, 1, 'REVENUE', 'Revenue', 1, null, null, 'Replace');

insert into kpi.mp_event_dimension_mapping (event_type_n, configuration_n, dimension_v, description_v, sequence_n, expression_v, procedure_v, correction_v) values (309, 1, 'REVENUE', 'Revenue', 1, null, null, 'Replace');

insert into kpi.mp_event_dimension_mapping (event_type_n, configuration_n, dimension_v, description_v, sequence_n, expression_v, procedure_v, correction_v) values (310, 1, 'REVENUE', 'Revenue', 1, null, null, 'Replace');

insert into kpi.mp_event_dimension_mapping (event_type_n, configuration_n, dimension_v, description_v, sequence_n, expression_v, procedure_v, correction_v) values (311, 1, 'QTY', 'Qty', 1, null, null, 'Replace');

insert into kpi.mp_event_dimension_mapping (event_type_n, configuration_n, dimension_v, description_v, sequence_n, expression_v, procedure_v, correction_v) values (312, 1, 'TOTAL_RELOAD', 'Total Reload', 1, null, null, 'Replace');
insert into kpi.mp_event_dimension_mapping (event_type_n, configuration_n, dimension_v, description_v, sequence_n, expression_v, procedure_v, correction_v) values (312, 1, 'CROSS_RELOAD', 'Cross Reload', 2, null, null, 'Replace');

insert into kpi.mp_event_dimension_mapping (event_type_n, configuration_n, dimension_v, description_v, sequence_n, expression_v, procedure_v, correction_v) values (313, 1, 'TOTAL_DATA', 'Total Data', 1, null, null, 'Replace');
insert into kpi.mp_event_dimension_mapping (event_type_n, configuration_n, dimension_v, description_v, sequence_n, expression_v, procedure_v, correction_v) values (313, 1, 'CROSS_DATA', 'Cross Data', 2, null, null, 'Replace');

insert into kpi.mp_event_dimension_mapping (event_type_n, configuration_n, dimension_v, description_v, sequence_n, expression_v, procedure_v, correction_v) values (314, 1, 'ACTUAL', 'Actual', 1, null, null, 'Replace');
insert into kpi.mp_event_dimension_mapping (event_type_n, configuration_n, dimension_v, description_v, sequence_n, expression_v, procedure_v, correction_v) values (314, 1, 'TARGET', 'Target', 2, null, null, 'Replace');

insert into kpi.mp_event_dimension_mapping (event_type_n, configuration_n, dimension_v, description_v, sequence_n, expression_v, procedure_v, correction_v) values (315, 1, 'PAYMENT_ALLOCATION', 'Patyment Allocation', 1, null, null, 'Replace');

insert into kpi.mp_event_dimension_mapping (event_type_n, configuration_n, dimension_v, description_v, sequence_n, expression_v, procedure_v, correction_v) values (316, 1, 'HIT', 'Hit', 1, null, null, 'Replace');
insert into kpi.mp_event_dimension_mapping (event_type_n, configuration_n, dimension_v, description_v, sequence_n, expression_v, procedure_v, correction_v) values (316, 1, 'AMOUNT', 'Amount', 2, null, null, 'Replace');
...
insert into kpi.mp_event_table_mapping(event_type_n, frequency_n, table_name_v, is_snapshot_bl) values (307, 1, 'kpi.tr_daily_total_revenue_aggr', false);
insert into kpi.mp_event_table_mapping(event_type_n, frequency_n, table_name_v, is_snapshot_bl) values (307, 2, 'kpi.tr_monthly_total_revenue_aggr', false);

insert into kpi.mp_event_table_mapping(event_type_n, frequency_n, table_name_v, is_snapshot_bl) values (308, 1, 'kpi.tr_daily_mobo_revenue_aggr', false);
insert into kpi.mp_event_table_mapping(event_type_n, frequency_n, table_name_v, is_snapshot_bl) values (308, 2, 'kpi.tr_monthly_mobo_revenue_aggr', false);

insert into kpi.mp_event_table_mapping(event_type_n, frequency_n, table_name_v, is_snapshot_bl) values (309, 1, 'kpi.tr_daily_aquisition_revenue_aggr', false);
insert into kpi.mp_event_table_mapping(event_type_n, frequency_n, table_name_v, is_snapshot_bl) values (309, 2, 'kpi.tr_monthly_aquisition_revenue_aggr', false);
...
insert into kpi.mp_event_table_mapping(event_type_n, frequency_n, table_name_v, is_snapshot_bl) values (315, 2, 'kpi.tr_monthly_alloc_payment_aggr', false);
...
drop table if exists kpi.tr_daily_total_revenue_aggr cascade;
create table kpi.tr_daily_total_revenue_aggr
(
	day_id_n 				numeric(08,0) not null,
	actor_type_n	 		numeric(19,0) not null,
	actor_id_n		 		numeric(19,0) not null,
	...
	system_type_v			character varying(25) not null default 'External',
	last_updated_time_dt	timestamp with time zone not null default now(),
	constraint tr_daily_total_revenue_aggr_pkey primary key (day_id_n, actor_type_n, actor_id_n, event_type_n, metrics_type_n, metrics_id_n, source_type_n, source_id_n, data_flag_n, instance_type_n, instance_id_n)
);

drop table if exists kpi.tr_monthly_total_revenue_aggr cascade;
create table kpi.tr_monthly_total_revenue_aggr
(
	month_id_n 				numeric(06,0) not null,
	actor_type_n	 		numeric(19,0) not null,
	actor_id_n		 		numeric(19,0) not null,
	...
	system_type_v			character varying(25) not null default 'External',
	last_updated_time_dt	timestamp with time zone not null default now(),
	constraint tr_monthly_total_revenue_aggr_pkey primary key (month_id_n, actor_type_n, actor_id_n, event_type_n, metrics_type_n, metrics_id_n, source_type_n, source_id_n, data_flag_n, instance_type_n, instance_id_n)
);

-- MOBO USAGE REVENUE:
drop table if exists kpi.tr_daily_mobo_revenue_aggr cascade;
create table kpi.tr_daily_mobo_revenue_aggr
(
	day_id_n 				numeric(08,0) not null,
	actor_type_n	 		numeric(19,0) not null,
	actor_id_n		 		numeric(19,0) not null,
	...
	system_type_v			character varying(25) not null default 'External',
	last_updated_time_dt	timestamp with time zone not null default now(),
	constraint tr_daily_mobo_revenue_aggr_pkey primary key (day_id_n, actor_type_n, actor_id_n, event_type_n, metrics_type_n, metrics_id_n, source_type_n, source_id_n, data_flag_n, instance_type_n, instance_id_n)
);

drop table if exists kpi.tr_monthly_mobo_revenue_aggr cascade;
create table kpi.tr_monthly_mobo_revenue_aggr
(
	month_id_n 				numeric(06,0) not null,
	actor_type_n	 		numeric(19,0) not null,
	actor_id_n		 		numeric(19,0) not null,
	...
	system_type_v			character varying(25) not null default 'External',
	last_updated_time_dt	timestamp with time zone not null default now(),
	constraint tr_monthly_mobo_revenue_aggr_pkey primary key (month_id_n, actor_type_n, actor_id_n, event_type_n, metrics_type_n, metrics_id_n, source_type_n, source_id_n, data_flag_n, instance_type_n, instance_id_n)
);

-- AQUISITION REVENUE:
drop table if exists kpi.tr_daily_aquisition_revenue_aggr cascade;
create table kpi.tr_daily_aquisition_revenue_aggr
(
	day_id_n 				numeric(08,0) not null,
	actor_type_n	 		numeric(19,0) not null,
	actor_id_n		 		numeric(19,0) not null,
	...
	system_type_v			character varying(25) not null default 'External',
	last_updated_time_dt	timestamp with time zone not null default now(),
	constraint tr_daily_aquisition_revenue_aggr_pkey primary key (day_id_n, actor_type_n, actor_id_n, event_type_n, metrics_type_n, metrics_id_n, source_type_n, source_id_n, data_flag_n, instance_type_n, instance_id_n)
);

drop table if exists kpi.tr_monthly_aquisition_revenue_aggr cascade;
create table kpi.tr_monthly_aquisition_revenue_aggr
(
	month_id_n 				numeric(06,0) not null,
	actor_type_n	 		numeric(19,0) not null,
	actor_id_n		 		numeric(19,0) not null,
	...
	system_type_v			character varying(25) not null default 'External',
	last_updated_time_dt	timestamp with time zone not null default now(),
	constraint tr_monthly_aquisition_revenue_aggr_pkey primary key (month_id_n, actor_type_n, actor_id_n, event_type_n, metrics_type_n, metrics_id_n, source_type_n, source_id_n, data_flag_n, instance_type_n, instance_id_n)
);
...
drop table if exists kpi.tr_monthly_alloc_payment_aggr cascade;
create table kpi.tr_monthly_alloc_payment_aggr
(
	month_id_n 				numeric(06,0) not null,
	actor_type_n	 		numeric(19,0) not null,
	actor_id_n		 		numeric(19,0) not null,
	...
	system_type_v			character varying(25) not null default 'External',
	last_updated_time_dt	timestamp with time zone not null default now(),
	constraint tr_monthly_alloc_payment_aggr_pkey primary key (month_id_n, actor_type_n, actor_id_n, event_type_n, metrics_type_n, metrics_id_n, source_type_n, source_id_n, data_flag_n, instance_type_n, instance_id_n)
);
...
-- PREPAID SERVICE REVENUE:
drop table if exists kpi.tr_temp_total_revenue_aggr cascade;
drop sequence if exists kpi.temp_total_revenue_aggr_seq cascade;

create sequence kpi.temp_total_revenue_aggr_seq increment by 1 start with 1001 minvalue 1 cache 1;
create table kpi.tr_temp_total_revenue_aggr
(
	temp_id_n 				numeric(19,0) not null default nextval('kpi.temp_total_revenue_aggr_seq'::regclass),
	id_n 					numeric(8,0) not null,
	actor_key_v 			character varying(255),
	actor_type_n 			numeric(19,0) not null default 0,
	actor_id_n 				numeric(19,0) not null default 0,
	...
	message_v 				character varying(255),
	last_updated_time_dt 	timestamp with time zone not null default now(),
	constraint tr_temp_total_revenue_aggr_pkey primary key (temp_id_n)
);

-- MOBO USAGE REVENUE:
drop table if exists kpi.tr_temp_mobo_revenue_aggr cascade;
drop sequence if exists kpi.temp_mobo_revenue_aggr_seq cascade;

create sequence kpi.temp_mobo_revenue_aggr_seq increment by 1 start with 1001 minvalue 1 cache 1;
create table kpi.tr_temp_mobo_revenue_aggr
(
	temp_id_n 				numeric(19,0) not null default nextval('kpi.temp_mobo_revenue_aggr_seq'::regclass),
	id_n 					numeric(8,0) not null,
	actor_key_v 			character varying(255),
	actor_type_n 			numeric(19,0) not null default 0,
	actor_id_n 				numeric(19,0) not null default 0,
	...
	message_v 				character varying(255),
	last_updated_time_dt 	timestamp with time zone not null default now(),
	constraint tr_temp_mobo_revenue_aggr_pkey primary key (temp_id_n)
);

-- AQUISITION REVENUE:
drop table if exists kpi.tr_temp_aquisition_revenue_aggr cascade;
drop sequence if exists kpi.temp_aquisition_revenue_aggr_seq cascade;

create sequence kpi.temp_aquisition_revenue_aggr_seq increment by 1 start with 1001 minvalue 1 cache 1;
create table kpi.tr_temp_aquisition_revenue_aggr
(
	temp_id_n 				numeric(19,0) not null default nextval('kpi.temp_aquisition_revenue_aggr_seq'::regclass),
	id_n 					numeric(8,0) not null,
	actor_key_v 			character varying(255),
	actor_type_n 			numeric(19,0) not null default 0,
	actor_id_n 				numeric(19,0) not null default 0,
	...
	message_v 				character varying(255),
	last_updated_time_dt 	timestamp with time zone not null default now(),
	constraint tr_temp_aquisition_revenue_aggr_pkey primary key (temp_id_n)
);
...
drop sequence if exists kpi.temp_cross_data_aggr_seq cascade;

create sequence kpi.temp_cross_data_aggr_seq increment by 1 start with 1001 minvalue 1 cache 1;
create table kpi.tr_temp_cross_data_aggr
(
	temp_id_n 				numeric(19,0) not null default nextval('kpi.temp_cross_data_aggr_seq'::regclass),
	id_n 					numeric(8,0) not null,
	actor_key_v 			character varying(255),
	actor_type_n 			numeric(19,0) not null default 0,
	actor_id_n 				numeric(19,0) not null default 0,
...
drop table if exists kpi.tr_temp_alloc_payment_aggr cascade;
drop sequence if exists kpi.temp_alloc_payment_aggr_seq cascade;

create sequence kpi.temp_alloc_payment_aggr_seq increment by 1 start with 1001 minvalue 1 cache 1;
create table kpi.tr_temp_alloc_payment_aggr
(
	temp_id_n 				numeric(19,0) not null default nextval('kpi.temp_alloc_payment_aggr_seq'::regclass),
	id_n 					numeric(8,0) not null,
	actor_key_v 			character varying(255),
	actor_type_n 			numeric(19,0) not null default 0,
	actor_id_n 				numeric(19,0) not null default 0,
	...
	message_v 				character varying(255),
	last_updated_time_dt 	timestamp with time zone not null default now(),
	constraint tr_temp_alloc_payment_aggr_pkey primary key (temp_id_n)
);
...
-- PREPAID SERVICE REVENUE:
drop table if exists kpi.tr_validate_total_revenue_aggr cascade;
create table kpi.tr_validate_total_revenue_aggr
(
	validation_str_v 		character varying(500) not null,
	created_dt 				date not null default now(),
	constraint tr_validate_total_revenue_aggr_pkey primary key (validation_str_v)
);

-- MOBO USAGE REVENUE:
drop table if exists kpi.tr_validate_mobo_revenue_aggr cascade;
create table kpi.tr_validate_mobo_revenue_aggr
(
	validation_str_v 		character varying(500) not null,
	created_dt 				date not null default now(),
	constraint tr_validate_mobo_revenue_aggr_pkey primary key (validation_str_v)
);

-- AQUISITION REVENUE:
drop table if exists kpi.tr_validate_aquisition_revenue_aggr cascade;
create table kpi.tr_validate_aquisition_revenue_aggr
(
	validation_str_v 		character varying(500) not null,
	created_dt 				date not null default now(),
	constraint tr_validate_aquisition_revenue_aggr_pkey primary key (validation_str_v)
);
...
-- ONETIME ALLOCATION PAYMENT:
drop table if exists kpi.tr_validate_alloc_payment_aggr cascade;
create table kpi.tr_validate_alloc_payment_aggr
(
	validation_str_v 		character varying(500) not null,
	created_dt 				date not null default now(),
	constraint tr_validate_alloc_payment_aggr_pkey primary key (validation_str_v)
);
...
-- PREPAID SERVICE REVENUE:
drop index if exists kpi.tr_temp_total_revenue_aggr_file_idx;
create index tr_temp_total_revenue_aggr_file_idx on kpi.tr_temp_total_revenue_aggr using btree (file_id_n);

drop index if exists kpi.tr_temp_total_revenue_aggr_update_keys_idx;
create index tr_temp_total_revenue_aggr_update_keys_idx on kpi.tr_temp_total_revenue_aggr using btree (status_flag_n, message_v);

-- MOBO USAGE REVENUE:
drop index if exists kpi.tr_temp_mobo_revenue_aggr_file_idx;
create index tr_temp_mobo_revenue_aggr_file_idx on kpi.tr_temp_mobo_revenue_aggr using btree (file_id_n);

drop index if exists kpi.tr_temp_mobo_revenue_aggr_update_keys_idx;
create index tr_temp_mobo_revenue_aggr_update_keys_idx on kpi.tr_temp_mobo_revenue_aggr using btree (status_flag_n, message_v);

-- AQUISITION REVENUE:
drop index if exists kpi.tr_temp_aquisition_revenue_aggr_file_idx;
create index tr_temp_aquisition_revenue_aggr_file_idx on kpi.tr_temp_aquisition_revenue_aggr using btree (file_id_n);

drop index if exists kpi.tr_temp_aquisition_revenue_aggr_update_keys_idx;
create index tr_temp_aquisition_revenue_aggr_update_keys_idx on kpi.tr_temp_aquisition_revenue_aggr using btree (status_flag_n, message_v);
...
-- ONETIME ALLOCATION PAYMENT:
drop index if exists kpi.tr_temp_alloc_payment_aggr_file_idx;
create index tr_temp_alloc_payment_aggr_file_idx on kpi.tr_temp_alloc_payment_aggr using btree (file_id_n);

drop index if exists kpi.tr_temp_alloc_payment_aggr_update_keys_idx;
create index tr_temp_alloc_payment_aggr_update_keys_idx on kpi.tr_temp_alloc_payment_aggr using btree (status_flag_n, message_v);
...
-- FAILURE TABLE SCRIPTS:
drop table if exists kpi.tr_temp_hadoop_failure_aggr cascade;
drop sequence if exists kpi.temp_hadoop_fail_seq cascade;

create sequence kpi.temp_hadoop_fail_seq increment by 1 start with 1001 minvalue 1 cache 1;
create table kpi.tr_temp_hadoop_failure_aggr
(
	temp_id_n 				numeric(19,0) not null default nextval('kpi.temp_hadoop_fail_seq'::regclass),
	...
	error_message 			text,
	last_updated_time_dt 	timestamp with time zone not null default now(),
	constraint tr_temp_hadoop_failure_aggr_pkey primary key (temp_id_n)
);
