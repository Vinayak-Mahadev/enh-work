package com.enhancesys.integration.snoc.util;
...
import com.enhancesys.integration.snoc.exception.GenericProcessorException;
...
public class Utilities 
{
	...
	{
		LOGGER.debug("getStartOfTheDay:: Parsing Object : "+object);
		Date date = null;
		...
		LOGGER.debug("getStartOfTheDay:: Returning Object : "+date);
		return date;
	}

	public static Date getEndOfTheDay(Object  object) throws Exception 
	{
		LOGGER.debug("getEndOfTheDay:: Parsing Object : "+object);
		Date date = null;
		...
		LOGGER.debug("getEndOfTheDay:: Returning Object : "+date);
		return date;
	}
