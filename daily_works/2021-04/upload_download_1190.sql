...
INSERT INTO INTERFACE.MS_INTERFACE (INTERFACE_ID_N, NAME_V, MODULE_ID_N, INTERFACE_TYPE_N, TRANS_TYPE_N, SEQ_N, CONVERTER_V, PUBLISHER_V, RESPONSE_PROCESSOR_V, LAST_UPDATED_TIME_DT) VALUES (1190, 'INTSRM001-Shopping Cart Creation', 268, 3, 1, 1, 'java:global/EnhancesysManagement/IntegrationServices/BeanXmlDataConverter!com.enhancesys.integration.services.interfaces.converter.DataConverter', 'java:global/EnhancesysManagement/IntegrationPublishers/WebServicePublisher!com.enhancesys.integration.services.interfaces.publisher.DataPublisher', NULL, now());
...
INSERT INTO INTERFACE.MS_INTERFACE_ATTR (ATTRIBUTE_ID_N, INTERFACE_ID_N, NAME_V, VALUE_V, LAST_UPDATED_TIME_DT) VALUES (1190010, 1190, 'Interface Summary Refdata Conf', '{"isEnabled":true,"refData1":"payout_type","refData2":"payout_id","refData3":"request_id","refData4":"sc_number","refData5":"","refData6":"","refData7":"","refData8":""}', now());
...
INSERT INTO INTERFACE.MS_INTERFACE (INTERFACE_ID_N, NAME_V, MODULE_ID_N, INTERFACE_TYPE_N, TRANS_TYPE_N, SEQ_N, CONVERTER_V, PUBLISHER_V, RESPONSE_PROCESSOR_V, LAST_UPDATED_TIME_DT) VALUES (1191, 'INTSRM002-Payout Status Update', 269, 3, 1, 1, 'java:global/EnhancesysManagement/IntegrationServices/BeanXmlDataConverter!com.enhancesys.integration.services.interfaces.converter.DataConverter', 'java:global/EnhancesysManagement/IntegrationPublishers/WebServicePublisher!com.enhancesys.integration.services.interfaces.publisher.DataPublisher', NULL, now());
...
INSERT INTO INTERFACE.MS_INTERFACE_ATTR (ATTRIBUTE_ID_N, INTERFACE_ID_N, NAME_V, VALUE_V, LAST_UPDATED_TIME_DT) VALUES (1191005, 1191, 'Service Type', 'SOAP', now());
...
INSERT INTO INTERFACE.MS_INTERFACE_ATTR (ATTRIBUTE_ID_N, INTERFACE_ID_N, NAME_V, VALUE_V, LAST_UPDATED_TIME_DT) VALUES (1191008, 1191, 'Xml Data Converter', 'java:global/EnhancesysManagement/IntegrationServices/BeanXmlDataConverter!com.enhancesys.integration.services.interfaces.converter.BeanDataConverter', now());
INSERT INTO INTERFACE.MS_INTERFACE_ATTR (ATTRIBUTE_ID_N, INTERFACE_ID_N, NAME_V, VALUE_V, LAST_UPDATED_TIME_DT) VALUES (1191009, 1191, 'Maintain Transactions Conf', 'true', now());
INSERT INTO INTERFACE.MS_INTERFACE_ATTR (ATTRIBUTE_ID_N, INTERFACE_ID_N, NAME_V, VALUE_V, LAST_UPDATED_TIME_DT) VALUES (1191010, 1191, 'Interface Summary Refdata Conf', '{"isEnabled":true,"refData1":"payout_type","refData2":"payout_id","refData3":"request_id","refData4":"sc_number","refData5":"","refData6":"","refData7":"","refData8":""}', now());
INSERT INTO INTERFACE.MS_INTERFACE_ATTR (ATTRIBUTE_ID_N, INTERFACE_ID_N, NAME_V, VALUE_V, LAST_UPDATED_TIME_DT) VALUES (1191011, 1191, 'Static Response Conf', '{"enabled":true,"file-enabled":true,"url":"http://interface.enhancesys.com:8080/interfaceResponseServices/webservices/InterfaceResponseServicesImpl?wsdl","res_type":"Success","replace-elements":{}}', now());
