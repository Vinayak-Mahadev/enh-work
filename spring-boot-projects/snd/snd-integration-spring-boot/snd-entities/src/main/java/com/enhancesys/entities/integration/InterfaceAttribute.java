...
@EntityListeners(value={com.enhancesys.entities.integration.Interfaces.AttributesListener.class})
public class InterfaceAttribute implements java.io.Serializable 
{
    ...
    public void setInterfaces(com.enhancesys.entities.integration.Interfaces arg)
    {
        ...
        com.enhancesys.entities.integration.Interfaces oldInterfaces = this.interfaces;
