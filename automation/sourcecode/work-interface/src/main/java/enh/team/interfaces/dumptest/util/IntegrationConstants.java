...
public interface IntegrationConstants 
{
	...
	public static final String SMSC_USER_ID =  PropertiesLoader.getValueFor("SMSC_USER_ID");

	public static final String SMSC_PASSWORD = PropertiesLoader.getValueFor("SMSC_PASSWORD");
	...
	public static final String ACTIVE_MQ_LOCAL_USER = PropertiesLoader.getValueFor("ACTIVE_MQ_LOCAL_USER");

	public static final String ACTIVE_MQ_LOCAL_PWD = PropertiesLoader.getValueFor("ACTIVE_MQ_LOCAL_PWD");
	...
	public static final String MONGO_DB_STANDALONE_USER = true ? (PropertiesLoader.getValueFor("MONGO_DB_STANDALONE_USER")) : PropertiesLoader.getValueFor("MONGO_DB_STANDALONE_USER");

	public static final String MONGO_DB_STANDALONE_DATABASE = true ? (PropertiesLoader.getValueFor("MONGO_DB_STANDALONE_DATABASE")) : PropertiesLoader.getValueFor("MONGO_DB_STANDALONE_DATABASE");

	public static final String MONGO_DB_STANDALONE_PASSWORD = true ? (PropertiesLoader.getValueFor("MONGO_DB_STANDALONE_PASSWORD")) : PropertiesLoader.getValueFor("MONGO_DB_STANDALONE_PASSWORD");

	public static final String MONGO_DB_R4_USER = true ? (PropertiesLoader.getValueFor("MONGO_DB_R4_USER")) : PropertiesLoader.getValueFor("MONGO_DB_R4_USER");

	public static final String MONGO_DB_R4_DATABASE = true ? (PropertiesLoader.getValueFor("MONGO_DB_R4_DATABASE")) : PropertiesLoader.getValueFor("MONGO_DB_R4_DATABASE");

	public static final String MONGO_DB_R4_PASSWORD = true ? (PropertiesLoader.getValueFor("MONGO_DB_R4_PASSWORD")) : PropertiesLoader.getValueFor("MONGO_DB_R4_PASSWORD");
	...
	public static final String SMTP_USER_NAME = true ? (PropertiesLoader.getValueFor("SMTP_USER_NAME")) : PropertiesLoader.getValueFor("SMTP_USER_NAME");

	public static final String SMTP_PASSWORD = true ? (PropertiesLoader.getValueFor("SMTP_PASSWORD")) : PropertiesLoader.getValueFor("SMTP_PASSWORD");

	public static final String SMTP_FROM_USER_NAME = true ? (PropertiesLoader.getValueFor("SMTP_FROM_USER_NAME")) : PropertiesLoader.getValueFor("SMTP_FROM_USER_NAME");
	...
	public static final String INTERFACE_JDBC_USER= true ? (PropertiesLoader.getValueFor("INTERFACE_JDBC_USER")) : PropertiesLoader.getValueFor("INTERFACE_JDBC_USER");

	public static final String INTERFACE_JDBC_PASS= true ? (PropertiesLoader.getValueFor("INTERFACE_JDBC_PASS")) : PropertiesLoader.getValueFor("INTERFACE_JDBC_PASS");
	...
	public static final String KPI_JDBC_USER= true ? (PropertiesLoader.getValueFor("KPI_JDBC_USER")) : PropertiesLoader.getValueFor("KPI_JDBC_USER");

	public static final String KPI_JDBC_PASS= true ? (PropertiesLoader.getValueFor("KPI_JDBC_PASS")) : PropertiesLoader.getValueFor("KPI_JDBC_PASS");

	public static final String KPI_SCHEMA_NAME= true ? (PropertiesLoader.getValueFor("KPI_SCHEMA_NAME")) : PropertiesLoader.getValueFor("KPI_SCHEMA_NAME");
	...
	public static final String ACTIVEMQ_USER_NAME = true ? (PropertiesLoader.getValueFor("ACTIVEMQ_USER_NAME")) : PropertiesLoader.getValueFor("ACTIVEMQ_USER_NAME");

	
	public static final String ACTIVEMQ_PASSWORD = true ? (PropertiesLoader.getValueFor("ACTIVEMQ_PASSWORD")) : PropertiesLoader.getValueFor("ACTIVEMQ_PASSWORD");
	...
	/*Interface partner file code optimization changes*/
