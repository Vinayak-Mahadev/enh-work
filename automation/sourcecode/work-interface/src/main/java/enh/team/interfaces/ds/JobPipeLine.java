...
//				log.info(pipeLineName + " : failureQueue.size() : " + failureQueue.size());
				...
				if(inputQueue != null)
				{
					...
					{
						if(outputObject.containsKey("payload"))
						{
...
//				log.info(pipeLineName + " : outputQueue : " + outputQueue + " : " + outputObject);
				if(outputQueue != null && outputObject != null)
				{
					if(outputObject.containsKey("payload"))
					{
						JSONArray dataArr = (JSONArray) ((JSONObject) outputObject.get("payload")).get("dataList");
				...
				else if(outputObject != null && (!outputObject.containsKey("payload") 
