...
@EntityListeners(value={com.enhancesys.entities.integration.Module.InterfacesListener.class})
public class Interfaces implements java.io.Serializable 
{
    ...
    public void setModule(com.enhancesys.entities.integration.Module arg)
    {
        ...
        com.enhancesys.entities.integration.Module oldModule = this.module;
        this.module = null;
        if(oldModule != null)
