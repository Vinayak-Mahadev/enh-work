...
INSERT INTO INTERFACE.MS_INTERFACE values(1162,'PJP Planned Calls Dump',240,2,1,1,'java:global/EnhancesysManagement/IntegrationServices/PJPPlannedCallsDump!com.enhancesys.integration.services.interfaces.processor.PullDataToFile','','',now());
...
INSERT INTO INTERFACE.MS_INTERFACE_ATTR (ATTRIBUTE_ID_N, INTERFACE_ID_N, NAME_V, VALUE_V, LAST_UPDATED_TIME_DT) VALUES (1162025, 1162, 'Processor Url', 'java:global/EnhancesysManagement/IntegrationServices/PJPPlannedCallsDump!com.enhancesys.integration.services.interfaces.processor.PullDataToFile', now());
INSERT INTO INTERFACE.MS_INTERFACE_ATTR (ATTRIBUTE_ID_N, INTERFACE_ID_N, NAME_V, VALUE_V, LAST_UPDATED_TIME_DT) VALUES (1162026, 1162, 'Client Id', '0', now());
INSERT INTO INTERFACE.MS_INTERFACE_ATTR (ATTRIBUTE_ID_N, INTERFACE_ID_N, NAME_V, VALUE_V, LAST_UPDATED_TIME_DT) VALUES (1162027, 1162, 'File Name Sequence', '001', now());
INSERT INTO INTERFACE.MS_INTERFACE_ATTR (ATTRIBUTE_ID_N, INTERFACE_ID_N, NAME_V, VALUE_V, LAST_UPDATED_TIME_DT) VALUES (1162028, 1162, 'Date Duration', '1', now());
