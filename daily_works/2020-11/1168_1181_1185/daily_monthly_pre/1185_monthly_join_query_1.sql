...
from
	...
	from
		...
		from 
			...
			left join kpi.ms_metrics_master checkin on checkin.metrics_type_n = 26 and temp.metrics_key_v = checkin.ext_reference_id_v
	...
	left join kpi.tr_monthly_dssf_attendance_aggr monthly1 on temp1.month_id_n = monthly1.month_id_n
