--1186_MONTHLY_JOIN_QUERY_2=
select 
	1186 as interface_id_n, 
...
from 
	...
	from 
		(select 
			...
			1 as id_flag 
		from 
			kpi.tr_temp_serious_outlet_aggr temp 
	...
	left join kpi.tr_monthly_serious_outlet_aggr monthly1 on temp1.month_id_n = monthly1.month_id_n 
