...
public interface IntegrationManagement
{
	...
	*/
	...
	public @WebResult(name = "sendFile") Boolean sendFile(Long fileId, String fileType) throws ApplicationException;
	...
	@WebFault(name = "GetInterfaceNotificationByInterfaceIdAndStatus")
	//@javax.ejb.ApplicationException(rollback = true)
	public static class GetInterfaceNotificationByInterfaceIdAndStatus extends ApplicationException
	{
		public GetInterfaceNotificationByInterfaceIdAndStatus()
		{
			super();
		}

		public GetInterfaceNotificationByInterfaceIdAndStatus(String message, Throwable cause)
		{
			super(message, cause);
		}
	}
