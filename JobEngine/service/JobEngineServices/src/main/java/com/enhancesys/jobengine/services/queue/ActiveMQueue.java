package com.enhancesys.jobengine.services.queue;
...
public class ActiveMQueue extends JobQueue
{
	...
	public ActiveMQueue(JSONObject configData)
	{
		super(configData);
...
//			properties.setProperty(Context.INITIAL_CONTEXT_FACTORY, "org.apache.activemq.jndi.ActiveMQInitialContextFactory");
	...
	{
		return new ActiveMQueue(configData);
	}
	...
	public JSONObject dequeue(JSONObject jobObject) throws GenericProcessorException
	{
		...
		try
		{
			...
			message = consumer.receive(pollWaitTime);
