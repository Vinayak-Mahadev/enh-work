...
//					log.info: lastFetchedObject : " + lastFetchedObject);
				if(lastFetchedObject != null)
				{
					...
					log.info(pipeLineName + " : " + processorName + " : " + name +  " : compareValue : " + passedValue + " : currObjectKeyVal : " + lastFetchedObjectValue);
...
//								log.info(pipeLineName + " : " + processorName + " : " + name + " : " + lastFetchedObject);
				...
				try 
				{
					if(cursor.next())
					{
						lastFetchedObject = Util.convertToDataList(cursor, columnCount);
...
//						log.error("jsonArray is having more than one element.." + jsonArray.size());
				...
				else
				{
					...
					log.error(pipeLineName + " : " + processorName + " : " + name +  " : " + keyField + " : Data Arr : " + jsonArray.size());
