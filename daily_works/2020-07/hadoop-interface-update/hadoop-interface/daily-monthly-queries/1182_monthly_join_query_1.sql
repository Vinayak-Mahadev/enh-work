--1182_MONTHLY_JOIN_QUERY_1=
select 
	1182 as interface_id_n,
...
from
	...
	from
		(select 
			...
			1 as id_flag
		from 
			kpi.tr_temp_sp_tagging_aggr temp
	...
	left join kpi.tr_monthly_sp_tagging_aggr monthly1 on temp1.month_id_n = monthly1.month_id_n
